...
import {updateProduct, getProductDetails, clearErrors} from '../../store/actions/productActions'
...
const UpdateProduct = ({match, history}) => {
    ...
    useEffect(() => {
        ...
        if (error) {
            alert.error('Product does not updated!');
                            ...
                            <form className="shadow-lg" onSubmit={submitHandler} encType='multipart/form-data'>
                                ...
                                <div className='form-group'>
                                    ...
                                    {oldImages && oldImages.map(img => (
                                        <img key={img.id} src={img.url} alt={img.name} className="mt-3 mr-2 same"/>
                                    ))}
